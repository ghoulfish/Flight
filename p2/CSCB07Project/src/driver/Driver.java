...
import travel.TravelComparator;
...
public class Driver {
  ...
  public static void uploadClientInfo(String path) {
    ...
    UserControl.getInstance().getDatabase()
        .addUsers(InputOperations.parseData(path, UserType.Client));
  }
  ...
  public static void uploadFlightInfo(String path) {
    ...
    UserControl.getInstance().getDatabase()
        .addTravels(InputOperations.parseData(path, TravelType.Flight));
  }
  ...
  public static String getClient(String email) {
    RegisteredUser user = UserControl.getInstance().getDatabase().getUser(email);
    if (user == null) {
  ...
  public static String getFlights(String date, String origin, String destination) {
    try {
      ...
      return InputOperations.formatCollection(
          UserControl.getInstance().getDatabase().searchTravels(TimeFormat.DATE.parseString(date),
              origin, destination, TravelType.Flight));
  ...
  public static String getItinerariesSortedByCost(String date, String origin,
      String destination) {
    return getItinerariesSorted(date, origin, destination, TravelComparator.Cost);
  }
  ...
  public static String getItinerariesSortedByTime(String date, String origin,
      String destination) {
    return getItinerariesSorted(date, origin, destination, TravelComparator.Time);
  }
  ...
  private static String getItinerariesSorted(String date, String origin, String destination,
    ...
    try {
      ...
      return InputOperations.formatCollection(UserControl.getInstance().getDatabase()
