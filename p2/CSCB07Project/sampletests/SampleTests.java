...
public class SampleTests {
  ...
  public static final String PATH = "sampletests/";
  ...
  public void testGetClient() throws Exception {
    ...
    String msg = "Unexpected client information or string output was returned.";
  ...
  public void testGetFlights() throws Exception {
    ...
    String msg = "Unexpected flight information or string output was returned.";
  ...
  public void testGetItineraries() throws Exception {
    ...
    String msg = "Unexpected itinerary information or string output was returned.";
